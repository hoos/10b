...
#
# 10b is a Java Algorithmic Analysis Application. 
# In a nutshell I want you to be able to use 10b to analyse any type of 
# dataset (numeric, textual, binary, etc) using algorithms of your own 
